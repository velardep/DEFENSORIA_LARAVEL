...
class Usuario extends Model
{
     ...
     */
    protected $fillable = ['password','ultimo_acceso', 'super_usuario', 'nombre_usuario', 'nombre', 'apellidos', 'correo', 'is_staff', 'activo', 'date_joined', 'acceso', 'id_oficinas', 'jerarquia'];
