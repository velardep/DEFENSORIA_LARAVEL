													...
													<table class="table border-hover tr-rounded card-table cardtbl-link">
														<tbody>
															<tr>
																...
																<td><a class="btn btn-outline-success float-end rounded" href="#">Completed</a></td>
															</tr>
															<tr>
																<td>
																	<span>
																...
																<td>
																	<a class="btn btn-outline-light float-end rounded" href="#">Pending</a>
																</td>
															</tr>
															<tr>
																<td>
																...
																<td>
																	<a class="btn btn-outline-danger float-end rounded" href="#">Canceled</a>
																</td>
															</tr>
															<tr>
																<td>
																...
																<td>
																	<a class="btn btn-outline-success float-end rounded" href="#">Completed</a>
																</td>
															</tr>
															<tr>
																<td>
									...
									<div class="card-body px-4">
										<div class="dropdown custom-dropdown d-block tbl-orders">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item" href="#">ETH coin</a>
											</div>
										</div>
										<div class="table-responsive">
								...
								<div class="card">
									...
									<div class="card-body pb-0 px-4">
										<div class="dropdown custom-dropdown d-block tbl-orders">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="#">Dash coin</a>
												<a class="dropdown-item" href="#">ETH coin</a>
											</div>
										</div>
										<div class="table-responsive">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="testimonial-two px-4 owl-carousel contacts-slider">
											<div class="items">
												<div class="text-center">
													...
													<h5 class="mb-0"><a class="text-black" href="#">Samuel</a></h5>
											...
											<div class="items">
												<div class="text-center">
													...
													<h5 class="mb-0"><a class="text-black" href="#">Cindy</a></h5>
											...
											<div class="items">
												<div class="text-center">
													...
													<h5 class="mb-0"><a class="text-black" href="#">David</a></h5>
											...
											<div class="items">
												<div class="text-center">
													...
													<h5 class="mb-0"><a class="text-black" href="#">Martha</a></h5>
											...
											<div class="items">
												<div class="text-center">
													...
													<h5 class="mb-0"><a class="text-black" href="#">Olivia</a></h5>
										...
										<div class="row pt-5 align-items-center">
											...
											<div class="col-sm-6">
												<a href="#" class="btn btn-primary d-block btn-lg rounded">TRANSFER NOW</a>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="basic-form">
											<form class="form-wrapper">
												...
												<div class="row mt-4 align-items-center">
													...
													<div class="col-lg-6">
														<div class="d-flex justify-content-end">
															<a href="#" class="btn  btn-success text-white rounded">
															BUY
															...
															<a href="#" class="btn btn-danger ms-3 rounded">
															SELL
